import { upullitDavieYard } from "./yard-metadata";
import {
...
export function transformUpullitDavieVehicle(
  ...
  return {
    ...
    locationCode: upullitDavieYard.code,
    locationName: upullitDavieYard.name,
    locationCity: upullitDavieYard.city,
    state: "Florida",
    stateAbbr: upullitDavieYard.state,
    lat: upullitDavieYard.lat,
    lng: upullitDavieYard.lng,
    section: null,
