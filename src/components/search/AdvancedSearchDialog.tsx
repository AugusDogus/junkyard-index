          ...
          <div className="scrollbar-thin-themed min-h-0 flex-1 overflow-y-auto px-6 py-6">
            ...
            >
              ...
              {canUseAdvancedFilters ? (
                ...
                <div className="mt-5 flex flex-col items-start justify-between gap-4 rounded-lg border p-5 sm:flex-row sm:items-center">
                  <div>
                    <p className="font-medium">Unlock inventory filters</p>
                    <p className="text-muted-foreground mt-1 max-w-2xl text-sm text-pretty">
                      Lite adds make, year, state, yard, color, and source
                      filters from ${PLANS.lite.monthlyPrice}/month. The keyword
                      builder remains available on every plan.
                    </p>
                  </div>
